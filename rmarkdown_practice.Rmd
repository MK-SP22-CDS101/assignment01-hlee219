...
<!-- Write your Markdown below this line --> # Section
**Section K02,G301**

#Course Goals 
By the end of the course, student wil be able to:

- Use [GitHub](https://github.com) for creating a reproducible research document.
      - My GitHub username is: *Hyoyong-Lee*. 
...
The output of first line of code is not printed out because it is assigned to a varied instead. 
